...
public class June extends AppCompatActivity {
    ...
    Button btn_date_21, btn_date_22, btn_date_23, btn_date_24, btn_date_25, btn_date_26, btn_date_27, btn_date_28, btn_date_29, btn_date_30;
    Button btnBack;
    Intent intent;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_date_29.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                intent = new Intent(getApplicationContext(), January.class);
                startActivity(intent);
        ...
        btn_date_30.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                intent = new Intent(getApplicationContext(), January.class);
                startActivity(intent);
